...
export class SidebarComponent {
  ...
  navGroups: NavGroup[] = [
    ...
    },
    {
      label: 'Routing',
      items: [
        { label: 'Routing', icon: 'route', route: '/routing',
          children: [
      ...
      items: [
        { label: 'Settings', icon: 'settings', route: '/settings',
          children: [
            ...
            { label: 'Themes',  icon: 'palette', route: '/settings/themes' },
          ],
        },
      ],
    },
  ...
  toggleExpand(item: NavItem): void {
    this.expandedItems.has(item.label)
  ...
  getIconPath(icon: string): string {
    const icons: Record<string, string> = {
      ...
      queue:      'M3 12h18 M3 6h18 M3 18h18',
      ...
      webhook:    'M18 16.98h-5.99c-1.66 0-3.01-1.34-3.01-3s1.35-3 3.01-3h5.99 M12 5.02h5.99c1.66 0 3.01 1.34 3.01 3s-1.35 3-3.01 3H12',
      monitoring: 'M18 20V10 M12 20V4 M6 20v-6',
      analytics:  'M12 20V10 M18 20V4 M6 20v-4',
      ...
      server:     'M2 4h20v5H2z M2 14h20v5H2z M6 7h.01 M6 17h.01',
      ...
      dovecot:    'M22 11.08V12a10 10 0 1 1-5.93-9.14 M22 4L12 14.01l-3-3',
      palette:    'M12 2a10 10 0 1 0 10 10A10 10 0 0 0 12 2zm-1 17.93V18a1 1 0 0 0-1-1H8a2 2 0 0 1-2-2v-.5a2.5 2.5 0 0 1 5 0V15h4v-1.5a2.5 2.5 0 0 1 5 0V14a6 6 0 0 1-9 5.93z',
    };
